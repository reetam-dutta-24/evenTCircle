        ...
        <div className='flex flex-col justify-center items-center w-full h-full p-5'>
            <div className='flex flex-col justify-center items-center gap-14 p-5 w-full h-full'>
                ...
                <div className='flex scroll-auto gap-10 justify-center items-center'>
                    ...
                    {/* Cards wrapper with fixed height to prevent layout shift */}
                            ...
                            >
                                ...
                                <div className='w-100 h-85 rounded-2xl glass border-l-[var(--purple-dark)] border-l-4 border-gray-700 p-8'>
                                    <div className='flex flex-col gap-5'>
                                        <User2 color='purple' size={40} className='bg-[var(--purple-dim)] rounded-lg p-2' />
                                        <p className='text-[var(--text-primary)]'>
                                            <span className='text-[var(--text-secondary)]'>By:</span> {reviewsList[currentReview[0] - 1].name}
                                        </p>
                                        <p className='text-[var(--text-secondary)]'>"{reviewsList[currentReview[0] - 1].review}"</p>
                                        <div className='p-2 w-fit rounded-full bg-[var(--purple-dim)]'>
                                            <p className='text-[var(--purple-accent)]'>{reviewsList[currentReview[0] - 1].location}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='w-100 h-85 rounded-2xl glass border-l-[var(--purple-dark)] border-l-4 border-gray-700 p-8'>
                                    <div className='flex flex-col gap-5'>
                                        <User2 color='purple' size={40} className='bg-[var(--purple-dim)] rounded-lg p-2' />
                                        <p className='text-[var(--text-primary)]'>
                                            <span className='text-[var(--text-secondary)]'>By:</span> {reviewsList[currentReview[1] - 1].name}
                                        </p>
                                        <p className='text-[var(--text-secondary)]'>"{reviewsList[currentReview[1] - 1].review}"</p>
                                        <div className='p-2 w-fit rounded-full bg-[var(--purple-dim)]'>
                                            <p className='text-[var(--purple-accent)]'>{reviewsList[currentReview[1] - 1].location}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='w-100 h-85 rounded-2xl glass border-l-[var(--purple-dark)] border-l-4 border-gray-700 p-8'>
                                    <div className='flex flex-col gap-5'>
                                        <User2 color='purple' size={40} className='bg-[var(--purple-dim)] rounded-lg p-2' />
                                        <p className='text-[var(--text-primary)]'>
                                            <span className='text-[var(--text-secondary)]'>By:</span> {reviewsList[currentReview[2] - 1].name}
                                        </p>
                                        <p className='text-[var(--text-secondary)]'>"{reviewsList[currentReview[2] - 1].review}"</p>
                                        <div className='p-2 w-fit rounded-full bg-[var(--purple-dim)]'>
                                            <p className='text-[var(--purple-accent)]'>{reviewsList[currentReview[2] - 1].location}</p>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
