...
function events() {
  return (
    <div className='flex flex-col p-8 items-center justify-center gap-14 '>
        <div>
        ...
        <div className='w-full h-full flex flex-wrap  justify-center gap-14'>
            {eventsList.map((event)=>(
                <div 
                  key={event.id} 
                  className=' relative rounded-lg w-60  h-40 flex flex-col gap-8 overflow-hidden'
                >
...
></div>
                    ...
                    <div className='flex flex-col justify-center p-3 items-center gap-5 '>
                      <div className='flex gap-4 items-center relative top-28'>
